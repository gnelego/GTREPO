...
@Autonomous(name = "AutoBlue_Front", group = "Sensor")
...
*/
            ...
            if(runtime.seconds() >= 10.1 && runtime.seconds() <= 11.0) {
                if (ColorRed == 1 ) {
                    ...
                    backleftmotor.setPower(.75);     //Faster FORWARD
                    backrightmotor.setPower(-.7);     //Faster FORWARD
            ...
            if(runtime.seconds() >= 15.1 && runtime.seconds() <= 15.5) {
                    ...
                    backleftmotor.setPower(.8);     //Faster FORWARD
                    backrightmotor.setPower(-.8);     //Faster FORWARD
            }
