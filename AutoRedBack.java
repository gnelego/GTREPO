...
@Autonomous(name = "AutoRed_Back", group = "Sensor")
...
*/
            ...
            if(runtime.seconds() >= 10.1 && runtime.seconds() <= 11.0) {
                if (ColorBlue == 1 ) {
                    ...
                    backleftmotor.setPower(.55);     //Faster FORWARD
                    backrightmotor.setPower(-.55);     //Faster FORWARD
                    //servo0.setPosition(1);
                    //servo1.setPosition(0);
                }
                else {
                    telemetry.addData("In Move Backward RED ", "Running: " + runtime.toString());
                    backleftmotor.setPower(.75);     //Faster BACKWARD
                    backrightmotor.setPower(-.75);     //Faster BACKWARD
                    //servo0.setPosition(1);
                    //servo1.setPosition(0);
